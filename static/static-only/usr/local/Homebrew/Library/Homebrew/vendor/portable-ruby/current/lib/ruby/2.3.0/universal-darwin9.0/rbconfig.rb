...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.3.0/universal-darwin9.0")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/usr/local/Cellar/portable-ruby/2.3.7")
  ...
  CONFIG["configure_args"] = " '--prefix=/usr/local/Cellar/portable-ruby/2.3.7' '--enable-load-relative' '--with-static-linked-ext' '--without-ext=tk' '--without-gmp' '--disable-install-doc' '--disable-install-rdoc' '--disable-dependency-tracking' '--with-arch=x86_64,i386' '--disable-dtrace' '--with-opt-dir=/usr/local/opt/portable-readline:/usr/local/opt/portable-libyaml:/usr/local/opt/portable-openssl' 'CC=cc' 'CFLAGS=-arch x86_64 -arch i386' 'LDFLAGS=-Wl,-search_paths_first' 'CXX=c++' 'CXXFLAGS=-arch x86_64 -arch i386'"
  ...
  CONFIG["arch"] = "#{arch && universal[/(?:\A|\s)#{Regexp.quote(arch)}=(\S+)/, 1] || 'universal'}-darwin9.0"
  ...
  CONFIG["DLDFLAGS"] = "-Wl,-undefined,dynamic_lookup -Wl,-multiply_defined,suppress -L/usr/local/opt/portable-readline/lib -L/usr/local/opt/portable-libyaml/lib -L/usr/local/opt/portable-openssl/lib"
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["LDFLAGS"] = "-L. -Wl,-search_paths_first -fstack-protector -L/usr/local/lib -L/usr/local/opt/portable-readline/lib -L/usr/local/opt/portable-libyaml/lib -L/usr/local/opt/portable-openssl/lib"
  CONFIG["CFLAGS"] = " -pipe"
  CONFIG["CXX"] = "c++"
  CONFIG["CC"] = "cc"
  ...
  CONFIG["target"] = "universal-apple-darwin9.0"
  CONFIG["host_os"] = "darwin9.8.0"
  CONFIG["host_vendor"] = "apple"
  CONFIG["host_cpu"] = "i386"
  CONFIG["host"] = "i386-apple-darwin9.8.0"
  ...
  CONFIG["build"] = "i386-apple-darwin9.8.0"
