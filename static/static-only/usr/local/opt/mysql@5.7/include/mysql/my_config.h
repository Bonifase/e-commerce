...
#define DEFAULT_MYSQL_HOME "/usr/local/Cellar/mysql@5.7/5.7.23"
#define SHAREDIR "/usr/local/Cellar/mysql@5.7/5.7.23/share/mysql"
#define DEFAULT_BASEDIR "/usr/local/Cellar/mysql@5.7/5.7.23"
#define MYSQL_DATADIR "/usr/local/var/mysql"
#define MYSQL_KEYRINGDIR "/usr/local/Cellar/mysql@5.7/5.7.23/keyring"
#define DEFAULT_CHARSET_HOME "/usr/local/Cellar/mysql@5.7/5.7.23"
#define PLUGINDIR "/usr/local/Cellar/mysql@5.7/5.7.23/lib/plugin"
...
#define INSTALL_DOCDIR "/usr/local/mysql/share/doc/mysql@5.7"
